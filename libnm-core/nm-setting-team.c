 ...
 **/
NMTeamLinkWatcher *
nm_setting_team_get_link_watcher (NMSettingTeam *setting, int idx)
{
	NMSettingTeamPrivate *priv = NM_SETTING_TEAM_GET_PRIVATE (setting);
 ...
 **/
void
nm_setting_team_remove_link_watcher (NMSettingTeam *setting, int idx)
{
	NMSettingTeamPrivate *priv = NM_SETTING_TEAM_GET_PRIVATE (setting);
...
{
	return nm_utils_team_link_watchers_to_variant (g_value_get_boxed (prop_value));
}
...
team_link_watchers_from_dbus (GVariant   *dbus_value,
                              GValue     *prop_value)
{
	g_value_take_boxed (prop_value, nm_utils_team_link_watchers_from_variant (dbus_value));
}
